...
void GameScene::Update() {
	{
		...
		if (input_->PushKey(DIK_R))
		{
			...
			player_ViewProjection_.up.x = 0;
			player_ViewProjection_.up.y = 0;
			player_ViewProjection_.up.z = 0;
		}
...
#pragma region 3Dオブジェクト描画
	...
	debugText_->Printf(
	  "eye:(%f,%f,%f)", player_ViewProjection_.up.x, player_ViewProjection_.up.y, player_ViewProjection_.up.z);
